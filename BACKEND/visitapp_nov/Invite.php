...
if (isset($_POST["Submit"])) {
    ...
    $stmt->bind_param("sssssssb", $Username, $InviteDate, $VisitorName, $VisitorEmail, $VisitorPhone, $VisitorID, $Parking, $qrImageData);
...
<form method="post" class="invite-form" id="qr-form">
